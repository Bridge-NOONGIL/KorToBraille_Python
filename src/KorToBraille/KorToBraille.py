...
class KorToBraille:
    ...
    def getBrailleFromJamo(self, n):
        if "가" <= n <= "힣":
            ...
            if cho == "" and jung == "ㅖ" and self.flag_10: # 제10항: 모음자에 '예'가 이어 나올 때에는 그 사이에 붙임표(⠤)를 적어 나타낸다.
                braille_jung = "⠤" + braille_jung
                self.flag_10 = False
            elif cho == "" and jung == "ㅐ" and self.flag_11: # 제11항: 'ㅑ,ㅘ,ㅜ,ㅝ'에 '애'가 이어 나올 때에는 그 사이에 붙임표(⠤)를 적어 나타낸다.
                braille_jung = "⠤" + braille_jung
                self.flag_11 = False
            elif cho == "" and self.flag_17: #제17항: 한 어절 안에서 'ㅏ'를 생략한 약자에 받침 글자가 없고 다음 음절이 모음으로 시작될 때에는 'ㅏ'를 생략하지 않는다.
            ...
            if jong == " ": # 종성 없음(모음자)
                ...
                if n == "것":
                    ...
                    braille_jong = ""
                    braille_jung = "⠠⠸⠎"
                elif n == "팠": # 한글점자규정 제17항 [붙임]: '팠'을 적을 때에는 'ㅏ'를 생략하지 않고 적는다.
                    braille_cho = ""
                    braille_jong = ""
                    braille_jung = "⠙⠣⠌"
